      ...
      <section className="outfit-sec">
        ...
        <div className="column">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <img src={golden} alt="golden-goose" width="200" />
          </a>
          <br />
          <br />
          <a
        ...
        <div className="column">
          ...
          <br />
          <a
            href="https://www.ssense.com/en-us/women/product/burberry/blue-vintage-check-bikini/9445001"
            target="_blank"
            rel="noreferrer"
          >
            <img src={burberry} alt="burberry-bikini" width="250" />
          </a>
          <br />
          <br />
          <a
        ...
        <div className="column">
          ...
          <br />
          <a
            href="https://www.ssense.com/en-us/women/product/rj-swim/ssense-exclusive-pink-and-orange-stella-bikini/9359851"
            target="_blank"
            rel="noreferrer"
          >
            <img src={rj} alt="rj-swim" width="250" />
          </a>
          <br />
          <br />
          <a
        ...
        <div className="column">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <img src={isa} alt="isa-boulder" width="250" />
          </a>
          <br />
          <br />
          <a
